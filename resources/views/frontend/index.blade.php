        ...
        <div data-ride="carousel" class="carousel slide" id="home-v1-header-carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <figure>
                        <img alt="Home Slide" src="{{ url('frontend/images/header-slider/home-v1/header-slide.jpg') }}" />
                    </figure>
                    <div class="container">
            ...
            <div id="category-filter">
                <ul class="category-list">
                    <li class="category-item adults">
                        <figure>
                            <img src="{{ url('frontend/images/category-filter/home-v1/category-filter-img-01.jpg') }}" alt="New Releaase" />
                    ...
                    <li class="category-item kids-teens">
                        <figure>
                            <img src="{{ url('frontend/images/category-filter/home-v1/category-filter-img-02.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item video">
                        <figure>
                            <img src="{{ url('frontend/images/category-filter/home-v1/category-filter-img-03.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item audio">
                        <figure>
                            <img src="{{ url('frontend/images/category-filter/home-v1/category-filter-img-04.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item books">
                        <figure>
                            <img src="{{ url('frontend/images/category-filter/home-v1/category-filter-img-05.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item magazines">
                        <figure>
                            <img src="{{ url('frontend/images/category-filter/home-v1/category-filter-img-06.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item adults">
                        <figure>
                            <img src="{{ url('frontend/images/category-filter/home-v1/category-filter-img-07.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
                    ...
                    <li class="category-item kids-teens">
                        <figure>
                            <img src="{{ url('frontend/images/category-filter/home-v1/category-filter-img-08.jpg') }}" alt="New Releaase" />
                            <figcaption class="bg-orange">
                                <div class="info-block">
                                    <h4>The Great Gatsby</h4>
                                    <span class="author"><strong>Author:</strong> F. Scott Fitzgerald</span>
            ...
            <div class="container">
                ...
                <div class="team-list">
                    <div class="team-member">
                        <figure>
                            <img src="{{ url('frontend/images/team-img-01.jpg') }}" alt="team" />
                        </figure>
                    ...
                    <div class="team-member">
                        <figure>
                            <img src="{{ url('frontend/images/team-img-02.jpg') }}" alt="team" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                    ...
                    <div class="team-member">
                        <figure>
                            <img src="{{url('frontend/images/team-img-03.jpg')}}" alt="team" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                                <h4>Anna Delpan</h4>
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs-list">
                        <div class="tab-content active">
                            <article>
                                <figure>
                                    <img src="{{ url('frontend/images/latest-blog-img-home-v1.jpg') }}" alt="Latest Blog">
                                    <figcaption>
                                        <a href="#.">
                        ...
                        <div class="tab-content">
                            <article>
                                <figure>
                                    <img src="{{ url('frontend/images/latest-blog-img-home-v1-2.jpg') }}" alt="Latest Blog">
                                    <figcaption>
                                        <a href="#.">
                ...
                <div class="owl-carousel">
                    <div class="single-testimonial-box">
                        <div class="top-portion">
                            <img src="{{ url('frontend/images/testimonial-image-01.jpg') }}" alt="Testimonial Image" />
                    ...
                    <div class="single-testimonial-box">
                        <div class="top-portion">
                            <img src="{{ url('frontend/images/testimonial-image-02.jpg') }}" alt="Testimonial Image" />
                            <div class="user-comment">
                                <div class="arrow-left"></div>
                                <blockquote cite="#">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent urna magna, rhoncus eget commodo et, dignissim non nulla. Sed sit amet vestibulum ex. Donec dolor velit
            ...
            <div class="container">
                ...
                <div class="news-events-list">
                    <div class="single-news-event">
                        <figure>
                            <img src="{{ url('frontend/images/news-event/news-event-01.jpg') }}" alt="News & Event" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                    ...
                    <div class="single-news-event">
                        <figure>
                            <img src="{{ url('frontend/images/news-event/news-event-02.jpg') }}" alt="News & Event" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                                <div class="content_meta_category">
                    ...
                    <div class="single-news-event">
                        <figure>
                            <img src="{{ url('frontend/images/news-event/news-event-03.jpg') }}" alt="News & Event" />
                        </figure>
                        <div class="content-block">
                            <div class="member-info">
                                <div class="content_meta_category">
