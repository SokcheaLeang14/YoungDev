...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		<!-- Begin::Main-->
		<p class="h1 text-center my-15">Sign-In Admin</p>
		<div class="d-flex justify-content-center align-items-center">
			<div class="col-lg-4">
				<img src="{{ asset('images/login.svg') }}" class="img-fluid">
			</div>
            <div class="col-lg-4 col-8 bg-ligth p-lg-5 p-sm-2 rounded shadow-lg">
                <form action="{{ url('/auth') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Password" required name="password" value="{{ old('password') }}"/>
                    </div>
